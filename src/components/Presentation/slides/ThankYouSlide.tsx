...
const ThankYouSlide = ({ slideNumber, totalSlides }: { slideNumber: number, totalSlides: number }) => {
  return (
    <Slide title="شكرًا لحسن استماعكم" slideNumber={slideNumber} totalSlides={totalSlides}>
      <div className="h-full flex flex-col items-center justify-center">
        ...
        <Card className="p-6 max-w-2xl text-center">
          ...
          <div className="border-t pt-6">
            <p className="font-bold mb-3">للتواصل والاستفسار</p>
            <p className="text-gray-700">strategic-team@example.com</p>
          </div>
        </Card>
      </div>
    </Slide>
